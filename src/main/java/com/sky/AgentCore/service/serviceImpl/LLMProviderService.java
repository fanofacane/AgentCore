...
public class LLMProviderService {
    ...
    public static ChatModel getStrand(String protocol, ProviderConfig providerConfig) {
        return LLMProviderFactory.getLLMProvider(protocol, providerConfig);
    }

    public static StreamingChatModel getStream(String protocol, ProviderConfig providerConfig) {
