...
public class EmbeddingDomainService implements MetadataConstant {
    ...
    public EmbeddingDomainService(EmbeddingModelFactory embeddingModelFactory,
                                  ...
                                  DocumentUnitMapper documentUnitMapper) {
    ...
    public void syncStorage(RagDocSyncStorageMessage ragDocSyncStorageMessage) {
        ...
        final FileDetailEntity fileDetailEntity = fileDetailMapper.selectById(ragDocSyncStorageMessage.getFileId());
        ...
        if (originalDocId != null) {
            documentUnitMapper.update(Wrappers.lambdaUpdate(DocumentUnitEntity.class)
        ...
        final Long isVector = documentUnitMapper.selectCount(Wrappers.lambdaQuery(DocumentUnitEntity.class)
