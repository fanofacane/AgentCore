...
import com.sky.AgentCore.converter.assembler.AgentWidgetAssembler;
...
public class AgentWidgetAppService {
    ...
    @Autowired
    private AgentWidgetAssembler agentWidgetAssembler;
    ...
    public AgentWidgetDTO createWidget(String agentId, CreateWidgetRequest request, String userId) {
        ...
        // 5. 获取关联的模型和服务商信息
        ModelEntity model = llmDomainService.selectModelById(widget.getModelId());
    ...
    public WidgetInfoForPublicAccess getWidgetInfoForPublicAccess(String publicId) {
        ...
        // 2. 获取关联的Agent信息
        AgentEntity agent = agentMapper.selectById(widget.getAgentId());
