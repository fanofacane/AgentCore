...
public class UserModelConfigResolver {
    ...
    private final UserSettingsDomainService userSettingsAppService;

    private final LLMDomainService llmDomainService;

    public UserModelConfigResolver(UserSettingsDomainService userSettingsAppService, LLMDomainService llmDomainService) {
    ...
    private ModelConfig getModelConfigFromDatabase(String modelId, String userId) {
        try {
            // 获取模型实体
            ModelEntity modelEntity = llmDomainService.selectModelById(modelId);
            if (modelEntity == null) {
