...
public class MemoryDomainService {
    ...
    public MemoryDomainService(MemoryItemMapper memoryItemMapper, EmbeddingModelFactory embeddingModelFactory,
    ...
    public List<String> saveMemories(String userId, String sessionId, List<CandidateMemory> candidates) {
        ...
        for (CandidateMemory c : candidates) {
            ...
            // 查重（同用户，同hash）
            MemoryItemEntity existed = memoryItemMapper.selectOne(Wrappers.<MemoryItemEntity>lambdaQuery()
            ...
            if (existed == null) {
                ...
                try {
                    memoryItemMapper.insert(toSave);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            } else {
                ...
                memoryItemMapper.updateById(toSave);
            }
    ...
    public Page<MemoryItemEntity> pageMemories(String userId, String type, int page, int pageSize) {
        ...
        memoryItemMapper.selectPage(mpPage, qw);
        return mpPage;
    }
    ...
    public List<MemoryItemEntity> listMemories(String userId, String type, Integer limit) {
        ...
        qw.orderByDesc(MemoryItemEntity::getUpdatedAt);
        List<MemoryItemEntity> list = memoryItemMapper.selectList(qw);
