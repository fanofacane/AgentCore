...
public class RagFileStorageStrategy implements FileStorageStrategy {
    ...
    public RagFileStorageStrategy(FileDetailMapper fileDetailMapper,
    ...
    public boolean delete(String url) {
        ...
        // 2. 删除关联的文档单元数据
        documentUnitMapper.delete(Wrappers.lambdaQuery(DocumentUnitEntity.class).eq(DocumentUnitEntity::getFileId,
