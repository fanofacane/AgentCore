...
import com.sky.AgentCore.dto.trace.TracingChatContext;
...
public abstract class TracingMessageHandler extends AbstractMessageHandler {
    ...
    public TracingMessageHandler(LLMServiceFactory llmServiceFactory, MessageService messageDomainService,
        ...
        super(llmServiceFactory, messageDomainService,userSettingsDomainService,billingService,
                ...
                accountService,chatSessionManager, highAvailabilityService);
