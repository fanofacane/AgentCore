...
import com.sky.AgentCore.dto.rag.RagRetrievalDocumentDTO;
import com.sky.AgentCore.dto.rag.RagRetrievalResult;
...
public class RagMessageHandler extends AbstractMessageHandler {
    ...
    public RagMessageHandler(LLMServiceFactory llmServiceFactory, MessageService messageDomainService,
                             HighAvailabilityService highAvailabilityDomainService, SessionService sessionDomainService,
                             UserSettingsDomainService userSettingsDomainService, LLMDomainService llmDomainService,
                             BuiltInToolRegistry builtInToolRegistry, BillingService billingService,
                             AccountAppService accountDomainService, ChatSessionManager chatSessionManager,
        ...
        super(llmServiceFactory, messageDomainService,userSettingsDomainService,billingService,
                llmDomainService, builtInToolRegistry,sessionDomainService,
                accountDomainService,chatSessionManager, highAvailabilityDomainService);
    ...
    private <T> void generateRagAnswer(RagChatContext ragContext, RagRetrievalResult retrievalResult, T connection,
        ...
        StreamingChatModel streamingClient = llmServiceFactory.getStreamingClient(ragContext.getProvider(),
                ragContext.getModel(),new LLMModelConfig());
    ...
    private <T> void processRagChat(Agent agent, T connection, MessageTransport<T> transport, RagChatContext ragContext,
        ...
        tokenStream.onError(throwable -> {
            ...
            highAvailabilityService.reportCallResult(ragContext.getInstanceId(), ragContext.getModel().getId(),
