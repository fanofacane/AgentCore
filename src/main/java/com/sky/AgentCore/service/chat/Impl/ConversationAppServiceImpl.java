...
public class ConversationAppServiceImpl implements ConversationAppService {
    ...
    private ChatContext prepareWidgetEnvironment(String publicId, WidgetChatRequest widgetChatRequest,
        ...
        // 3. 获取Widget配置指定的模型
        ModelEntity model = llmDomainService.selectModelById(widgetEntity.getModelId());
        ...
        HighAvailabilityResult result = highAvailabilityService.selectBestProvider(model, creatorUserId,
