package com.sky.AgentCore.service.tool.builtin;


import com.sky.AgentCore.dto.agent.AgentEntity;
import com.sky.AgentCore.dto.tool.ToolDefinition;
...
/** 内置工具提供者接口
 * 所有内置工具都必须实现此接口，用于向AgentCore系统提供工具能力 内置工具是系统预置的功能模块，如RAG搜索、天气查询、计算器等
...
public interface BuiltInToolProvider {
    ...
    default Map<ToolSpecification, ToolExecutor> createTools(AgentEntity agent) {
        ...
        if (definitions == null || definitions.isEmpty()) return new HashMap<>();
