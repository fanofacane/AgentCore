package com.sky.AgentCore.config.Interceptor;
...
public class ExternalApiKeyInterceptor implements HandlerInterceptor {
    ...
    public ExternalApiKeyInterceptor(ApiKeyService apiKeyService, ObjectMapper objectMapper) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        // 验证API Key
        try {
            ApiKeyEntity apiKeyEntity = apiKeyService.validateApiKey(apiKey);

            // 更新使用统计
            apiKeyService.updateUsage(apiKey);
