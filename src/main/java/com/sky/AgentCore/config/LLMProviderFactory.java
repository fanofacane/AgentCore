...
public class LLMProviderFactory {
    ...
    public static ChatModel getLLMProvider(String protocol, ProviderConfig providerConfig) {
        ChatModel model = null;
        if (protocol.equals("OPENAI")) {
...
/*        else if (protocol == ProviderProtocol.ANTHROPIC) {
    ...
    public static StreamingChatModel getLLMProviderByStream(String protocol, ProviderConfig providerConfig) {
