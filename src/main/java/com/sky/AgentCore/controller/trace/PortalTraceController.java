package com.sky.AgentCore.controller.trace;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.sky.AgentCore.dto.common.Result;
import com.sky.AgentCore.dto.trace.*;
import com.sky.AgentCore.service.trace.AgentExecutionTraceAppService;
import com.sky.AgentCore.service.trace.AgentExecutionTraceDomainService;
...
public class PortalTraceController {
    @Autowired
    private AgentExecutionTraceAppService traceAppService;
    @Autowired
    ...
    public Result<Page<SessionTraceStatisticsDTO>> getAgentSessionTraceStatistics(@PathVariable String agentId,
                                                                                  SessionTraceListRequest request) {
        String userId = UserContext.getCurrentUserId();
        Page<SessionTraceStatisticsDTO> result = traceAppService.getAgentSessionTraceStatistics(agentId, request,
                userId);
        return Result.success(result);
    }
}
